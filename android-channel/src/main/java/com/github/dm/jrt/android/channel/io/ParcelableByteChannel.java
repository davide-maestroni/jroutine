 ...
 *   ...
 *   final ChunkOutputStream outputStream = ParcelableByteChannel.outputStream(result)
 *                                                                .buildOutputStream();
 *   ...
 * }
 * </code></pre>
 ...
 *   ...
 *   final ChunkInputStream inputStream = ParcelableByteChannel.inputStream(chunk);
 *   ...
 * }
 * </code></pre>
