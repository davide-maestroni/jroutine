...
public class SparseChannelsCompat extends AndroidChannels {
   ...
   */
  @NotNull
  public static <DATA, IN extends DATA> ChannelArrayCompatBuilder<IN, ?> parcelableFlowInput(
   ...
   */
  @NotNull
  public static <OUT> ChannelArrayCompatBuilder<?, OUT> parcelableFlowOutput(
   ...
   */
  @NotNull
  public static <OUT> ChannelArrayCompatBuilder<?, OUT> parcelableFlowOutput(final int startId,
      final int rangeSize,
      @NotNull final Channel<?, ? extends ParcelableFlow<? extends OUT>> channel) {
    ConstantConditions.positive("range size", rangeSize);
    final HashSet<Integer> idSet = new HashSet<Integer>();
