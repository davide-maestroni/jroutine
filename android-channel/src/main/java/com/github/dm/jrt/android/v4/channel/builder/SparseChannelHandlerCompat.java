 ...
 */
public interface SparseChannelHandlerCompat extends AndroidChannelHandler {
   ...
   */
  @NotNull
  <DATA, IN extends DATA> SparseArrayCompat<Channel<IN, ?>> inputOfParcelableFlow(
   ...
   */
  @NotNull
  <DATA, IN extends DATA> SparseArrayCompat<Channel<IN, ?>> inputOfParcelableFlow(int startId,
  ...
  <IN> Channel<FlowData<? extends IN>, ?> mergeParcelableInputOf(
      @NotNull SparseArrayCompat<? extends Channel<? extends IN, ?>> channels);
  ...
  <OUT> Channel<?, ParcelableFlowData<OUT>> mergeParcelableOutputOf(
      @NotNull SparseArrayCompat<? extends Channel<?, ? extends OUT>> channels);
   ...
   */
  @NotNull
  <OUT> SparseArrayCompat<Channel<?, OUT>> outputOfParcelableFlow(
   ...
   */
  @NotNull
  <OUT> SparseArrayCompat<Channel<?, OUT>> outputOfParcelableFlow(int startId, int rangeSize,
      @NotNull Channel<?, ? extends ParcelableFlowData<? extends OUT>> channel);
  ...
  @NotNull
  @Override
  Builder<? extends SparseChannelHandlerCompat> withChannel();
  ...
  @NotNull
  @Override
  SparseChannelHandlerCompat withConfiguration(@NotNull ChannelConfiguration configuration);
}
