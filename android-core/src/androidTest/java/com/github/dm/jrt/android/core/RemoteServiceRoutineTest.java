...
public class RemoteServiceRoutineTest extends ActivityInstrumentationTestCase2<TestActivity> {
  ...
  public void testAbort() {
    ...
    final Channel<?, Data> channel = JRoutineService.routineOn(
  ...
  public void testBuilderError() {
    ...
    try {
      ...
      JRoutineService.routineOn(
          ServiceSource.serviceOf(getActivity(), RemoteInvocationService.class)).of(null);
  ...
  public void testConfigurationErrors() {
    ...
    try {
      ...
      new DefaultServiceRoutineBuilder(
  ...
  public void testExecutionTimeout() {
    ...
    final Channel<?, String> channel = JRoutineService.routineOn(
        ServiceSource.serviceOf(getActivity(), RemoteInvocationService.class))
                                                      .withInvocation()
  ...
  public void testInvocations() throws InterruptedException {
    ...
    final Routine<String, String> routine1 = JRoutineService.routineOn(
        ServiceSource.serviceOf(getActivity(), RemoteInvocationService.class))
                                                            .withInvocation()
                                                            .withInputOrder(OrderType.UNSORTED)
                                                            .withLogLevel(Level.DEBUG)
  ...
  public void testInvocations2() throws InterruptedException {
    ...
    final Routine<String, String> routine2 = JRoutineService.routineOn(
        ServiceSource.serviceOf(getActivity(), RemoteInvocationService.class))
                                                            .withInvocation()
  ...
  public void testInvocations3() throws InterruptedException {
    ...
    final Routine<String, String> routine3 = JRoutineService.routineOn(
        ServiceSource.serviceOf(getActivity(), RemoteInvocationService.class))
                                                            .withInvocation()
  ...
  public void testInvocations4() throws InterruptedException {
    ...
    final InvocationFactoryReference<String, String> targetFactory =
        factoryOf(StringCallInvocation.class);
    final Routine<String, String> routine4 = JRoutineService.routineOn(
        ServiceSource.serviceOf(getActivity(), RemoteInvocationService.class))
                                                            .withInvocation()
  ...
  public void testInvocations5() throws InterruptedException {
    ...
    final Routine<Void, String> routine5 = JRoutineService.routineOn(
        ServiceSource.serviceOf(getActivity(), RemoteInvocationService.class))
                                                          .withInvocation()
                                                          .withCoreInvocations(0)
                                                          .withMaxInvocations(2)
  ...
  public void testParcelable() {
    ...
    assertThat(JRoutineService.routineOn(
        ServiceSource.serviceOf(getActivity(), RemoteInvocationService.class))
