...
/**
 * Abstract implementation of a stateful Context builder.
 * <p>
 ...
 */
public class AbstractStatefulContextBuilder<IN, OUT, STATE, TYPE extends
    StatefulContextBuilder<IN, OUT, STATE, TYPE>>
    extends AbstractStatefulBuilder<IN, OUT, STATE, TYPE>
    implements StatefulContextBuilder<IN, OUT, STATE, TYPE> {
