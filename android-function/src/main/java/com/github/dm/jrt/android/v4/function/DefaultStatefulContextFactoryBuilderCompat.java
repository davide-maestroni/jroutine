...
import com.github.dm.jrt.android.function.builder.AbstractStatefulContextBuilder;
...
/**
 * Default implementation of a stateful Context factory builder.
 * <p>
 ...
 */
class DefaultStatefulContextFactoryBuilderCompat<IN, OUT, STATE> extends
    AbstractStatefulContextBuilder<IN, OUT, STATE, StatefulContextFactoryBuilder<IN, OUT, STATE>>
    implements StatefulContextFactoryBuilder<IN, OUT, STATE> {

  @NotNull
  @Override
  public ContextInvocationFactory<IN, OUT> create() {
    return new StatefulContextInvocationFactory<IN, OUT, STATE>(getOnContext(), getOnCreateState(),
        getOnNext(), getOnError(), getOnComplete(), getOnFinalize(), getOnDestroy());
  }
