...
public class LoaderProxyCompatActivityTest extends ActivityInstrumentationTestCase2<TestActivity> {
  ...
  public void testClassStaticMethod() {
    ...
    final TestStatic testStatic = JRoutineLoaderProxyCompat.wrapperOn(loaderOf(getActivity()))
                                                           .withInvocation()
  ...
  public void testGenericProxyCache() {
    ...
    final LoaderProxyRoutineBuilder builder =
        JRoutineLoaderProxyCompat.wrapperOn(loaderOf(getActivity()))
                                 .withInvocation()
  ...
  public void testProxy() {
    ...
    final TestProxy testProxy = JRoutineLoaderProxyCompat.wrapperOn(loaderOf(getActivity()))
                                                         .withInvocation()
                                                         .withLogLevel(Level.DEBUG)
                                                         .withLog(log)
                                                         .configuration()
  ...
  public void testProxyBuilder() {
    ...
    final LoaderProxyObjectBuilder<TestProxy> builder =
        com.github.dm.jrt.android.proxy.LoaderProxyCompat_TestActivity.wrapperOn(
    ...
    assertThat(JRoutineLoaderProxyCompat.wrapperOn(loaderOf(getActivity()))
                                        .withInvocation()
                                        .withPatch(configuration)
                                        .configuration()
                                        .withWrapper()
  ...
  public void testTemplates() {
    ...
    final Itf itf = JRoutineLoaderProxyCompat.wrapperOn(loaderOf(getActivity()))
                                             .withInvocation()
                                             .withOutputTimeout(seconds(10))
                                             .configuration()
