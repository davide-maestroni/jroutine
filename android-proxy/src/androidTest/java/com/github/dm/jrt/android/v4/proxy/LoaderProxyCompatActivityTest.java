...
public class LoaderProxyCompatActivityTest extends ActivityInstrumentationTestCase2<TestActivity> {

  public LoaderProxyCompatActivityTest() {
  ...
  public void testClassStaticMethod() {
    ...
    final TestStatic testStatic = JRoutineLoaderProxyCompat.on(LoaderSourceCompat.loaderOf(getActivity()))
  ...
  public void testGenericProxyCache() {
    ...
    final LoaderProxyRoutineBuilder builder =
        JRoutineLoaderProxyCompat.on(LoaderSourceCompat.loaderOf(getActivity()))
  ...
  public void testInterface() {
    ...
    final TestInterfaceProxy testProxy = JRoutineLoaderProxyCompat.on(LoaderSourceCompat.loaderOf(getActivity()))
  ...
  public void testProxy() {
    ...
    final TestProxy testProxy = JRoutineLoaderProxyCompat.on(LoaderSourceCompat.loaderOf(getActivity()))
                                                         .with(instanceOf(TestClass.class))
                                                         .withInvocation()
  ...
  public void testProxyBuilder() {
    ...
    assertThat(JRoutineLoaderProxyCompat.on(LoaderSourceCompat.loaderOf(getActivity()))
                                        .with(instanceOf(TestClass.class))
                                        .withInvocation()
                                        .withPatch(configuration)
                                        .configuration()
  ...
  public void testTemplates() {
    ...
    final Itf itf = JRoutineLoaderProxyCompat.on(LoaderSourceCompat.loaderOf(getActivity()))
