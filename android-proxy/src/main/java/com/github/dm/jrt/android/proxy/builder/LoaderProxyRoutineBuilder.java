...
public interface LoaderProxyRoutineBuilder
  ...
  @NotNull
  @Override
  LoaderProxyRoutineBuilder apply(@NotNull WrapperConfiguration configuration);
  ...
  @NotNull
  @Override
  WrapperConfiguration.Builder<? extends LoaderProxyRoutineBuilder> wrapperConfiguration();
}
