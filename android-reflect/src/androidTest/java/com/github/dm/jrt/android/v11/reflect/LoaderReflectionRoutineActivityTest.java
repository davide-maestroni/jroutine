...
public class LoaderReflectionRoutineActivityTest
  ...
  public void testActivityNullPointerErrors() {
    ...
    try {
      ...
      JRoutineLoader.routineOn(null).of(factoryOf(TestInvocation.class));
    ...
    try {
      ...
      JRoutineLoaderReflection.wrapperOn(null);
  ...
  public void testAliasMethod() throws NoSuchMethodException {
    ...
    final Routine<Object, Object> routine =
        JRoutineLoaderReflection.wrapperOn(loaderOf(getActivity()))
                                .withInvocation()
  ...
  public void testArgs() {
    ...
    assertThat(JRoutineLoaderReflection.wrapperOn(loaderOf(getActivity()))
  ...
  public void testAsyncInputProxyRoutine() {
    ...
    final DurationMeasure timeout = seconds(10);
    final SumItf sumAsync = JRoutineLoaderReflection.wrapperOn(loaderOf(getActivity()))
                                                    .withInvocation()
  ...
  public void testAsyncOutputProxyRoutine() {
    ...
    final DurationMeasure timeout = seconds(10);
    final CountItf countAsync = JRoutineLoaderReflection.wrapperOn(loaderOf(getActivity()))
                                                        .withInvocation()
                                                        .withOutputTimeout(timeout)
                                                        .configuration()
  ...
  public void testContextWrapper() {
    ...
    assertThat(JRoutineLoaderReflection.wrapperOn(loaderOf(activity, contextWrapper))
  ...
  public void testProxyAnnotations() {
    ...
    final Itf itf = JRoutineLoaderReflection.wrapperOn(loaderOf(getActivity()))
                                            .withInvocation()
  ...
  public void testProxyRoutine() {
    ...
    final SquareItf squareAsync = JRoutineLoaderReflection.wrapperOn(loaderOf(getActivity()))
