...
public class LoaderReflectionRoutineFragmentTest
  ...
  public void testAliasMethod() throws NoSuchMethodException {
    ...
    final Routine<Object, Object> routine =
        JRoutineLoaderReflection.wrapperOn(LoaderSource.loaderOf(fragment))
                                .withInvocation()
  ...
  public void testArgs() {
    ...
    final TestFragment fragment =
        (TestFragment) getActivity().getFragmentManager().findFragmentById(R.id.test_fragment);
    assertThat(JRoutineLoaderReflection.wrapperOn(LoaderSource.loaderOf(fragment))
  ...
  public void testAsyncInputProxyRoutine() {
    ...
    final TestFragment fragment =
        (TestFragment) getActivity().getFragmentManager().findFragmentById(R.id.test_fragment);
    final SumItf sumAsync = JRoutineLoaderReflection.wrapperOn(LoaderSource.loaderOf(fragment))
                                                    .withInvocation()
                                                    .withOutputTimeout(timeout)
                                                    .configuration()
                                                    .proxyOf(instanceOf(Sum.class), SumItf.class);
  ...
  public void testAsyncOutputProxyRoutine() {
    ...
    final TestFragment fragment =
        (TestFragment) getActivity().getFragmentManager().findFragmentById(R.id.test_fragment);
    final CountItf countAsync = JRoutineLoaderReflection.wrapperOn(LoaderSource.loaderOf(fragment))
                                                        .withInvocation()
                                                        .withOutputTimeout(timeout)
                                                        .configuration()
  ...
  public void testConfigurationErrors() {
    ...
    try {
      ...
      new DefaultLoaderReflectionRoutineBuilder(LoaderSource.loaderOf(fragment)).withConfiguration(
  ...
  public void testContextWrapper() {
    ...
    assertThat(JRoutineLoaderReflection.wrapperOn(LoaderSource.loaderOf(fragment, contextWrapper))
  ...
  public void testProxyAnnotations() {
    ...
    final TestFragment fragment =
        (TestFragment) getActivity().getFragmentManager().findFragmentById(R.id.test_fragment);
    final Itf itf = JRoutineLoaderReflection.wrapperOn(LoaderSource.loaderOf(fragment))
                                            .withInvocation()
