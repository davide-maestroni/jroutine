...
public class RoutineRxTest extends ActivityInstrumentationTestCase2<TestActivity> {

  public RoutineRxTest() {
  ...
  public void testActivity() throws InterruptedException {
    ...
    JRoutineRx.withObservable(Observable.just("test1", "test2", "test3"))
