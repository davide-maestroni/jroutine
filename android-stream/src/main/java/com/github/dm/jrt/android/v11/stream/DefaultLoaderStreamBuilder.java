...
class DefaultLoaderStreamBuilder<IN, OUT> extends AbstractStreamBuilder<IN, OUT>
  ...
  DefaultLoaderStreamBuilder() {
    this(new DefaultLoaderStreamConfiguration(null, LoaderConfiguration.defaultConfiguration(),
        LoaderConfiguration.defaultConfiguration(), InvocationConfiguration.defaultConfiguration(),
   ...
   */
  private DefaultLoaderStreamBuilder(@NotNull final LoaderStreamConfiguration streamConfiguration) {
  ...
  @NotNull
  @Override
  public LoaderStreamBuilder<IN, OUT> apply(@NotNull final InvocationConfiguration configuration) {
  ...
  public <BEFORE, AFTER> LoaderStreamBuilder<BEFORE, AFTER> lift(
    ...
    return (LoaderStreamBuilder<BEFORE, AFTER>) super.lift(liftingFunction);
  }
  ...
  public <BEFORE, AFTER> LoaderStreamBuilder<BEFORE, AFTER> liftWithConfig(
    ...
    checkStatic(decorate(liftingFunction), liftingFunction);
    return (LoaderStreamBuilder<BEFORE, AFTER>) super.liftWithConfig(liftingFunction);
  }
