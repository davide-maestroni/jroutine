 ...
 * <p/>
 * Created by davide-maestroni on 03/30/15.
 */
...
public class ServiceObjectRoutineTest extends ActivityInstrumentationTestCase2<TestActivity> {
    ...
    public void testArgs() {
        ...
        assertThat(JRoutine.on(serviceFrom(getActivity()), targetObject(TestArgs.class, 17))
                           .method("getId")
                           .asyncCall()
                           .eventually()
                           .next()).isEqualTo(17);
    ...
    public void testAsyncInputProxyRoutine() {
        ...
        final TimeDuration timeout = seconds(10);
        final SumItf sumAsync = JRoutine.on(serviceFrom(getActivity()), targetObject(Sum.class))
                                        .invocations()
    ...
    public void testAsyncOutputProxyRoutine() {
        ...
        final CountItf countAsync =
                JRoutine.on(serviceFrom(getActivity()), targetObject(Count.class))
                        .invocations()
                        .withExecutionTimeout(timeout)
                        .set()
    ...
    public void testDuplicateAnnotationError() {
        ...
        try {
            ...
            JRoutine.on(serviceFrom(getActivity()), targetObject(DuplicateAnnotation.class))
    ...
    public void testInvalidProxyInputAnnotationError() {
        ...
        try {
            ...
            JRoutine.on(serviceFrom(getActivity()), targetObject(Sum.class))
    ...
    public void testMissingMethodError() {
        ...
        try {
            ...
            JRoutine.on(serviceFrom(getActivity()), targetObject(TestClass.class)).method("test");
    ...
    public void testNullPointerError() {
        ...
        try {
            ...
            JRoutine.on(serviceFrom(getActivity()), targetObject(null));
    ...
    public void testProxyAnnotations() {
        ...
        final Itf itf = JRoutine.on(serviceFrom(getActivity()), targetObject(Impl.class))
                                .invocations()
                                .withExecutionTimeout(INFINITY)
                                .set()
    ...
    public void testProxyRoutine() {
        ...
        final SquareItf squareAsync =
                JRoutine.on(serviceFrom(getActivity()), targetObject(Square.class))
        ...
        final IncItf incItf = JRoutine.on(serviceFrom(getActivity()), targetObject(Inc.class))
    ...
    public void testTimeoutActionAnnotation() throws NoSuchMethodException {
        ...
        assertThat(JRoutine.on(serviceFrom(getActivity()), targetObject(TestTimeout.class))
                           .invocations()
                           .withExecutionTimeout(seconds(10))
                           .set()
                           .aliasMethod("test")
        ...
        try {
            ...
            JRoutine.on(serviceFrom(getActivity()), targetObject(TestTimeout.class))
                    .invocations()
