...
public interface ServiceBuilder {
     ...
     */
    @Nonnull
    ServiceBuilder dispatchingOn(@Nullable Looper looper);
     ...
     */
    @Nonnull
    ServiceBuilder withLogClass(@Nullable Class<? extends Log> logClass);
     ...
     */
    @Nonnull
    ServiceBuilder withRunnerClass(@Nullable Class<? extends Runner> runnerClass);
     ...
     */
    @Nonnull
    ServiceBuilder withServiceClass(@Nullable Class<? extends RoutineService> serviceClass);
}
