...
class DefaultAndroidRoutine<INPUT, OUTPUT> extends AbstractRoutine<INPUT, OUTPUT>
    ...
    DefaultAndroidRoutine(@Nonnull final RoutineConfiguration configuration,
            @Nonnull final WeakReference<Object> context, final int id,
    ...
    public void purge() {
        ...
        if (context.get() != null) {
            ...
            Runners.mainRunner()
                   .run(new PurgeExecution(context, mId, mConstructor.getDeclaringClass()), 0,
    ...
    protected Invocation<INPUT, OUTPUT> newInvocation(final boolean async) {
        ...
        if (async) {
            ...
            return new LoaderInvocation<INPUT, OUTPUT>(mContext, mId, mClashResolution,
    ...
    public void purge(@Nullable final INPUT input) {
        ...
        if (context.get() != null) {
            ...
            Runners.mainRunner()
                   .run(new PurgeInputsExecution<INPUT>(context, mId,
    ...
    private static class PurgeExecution implements Execution {
        ...
        public void run() {
            ...
            if (context != null) {
                ...
                LoaderInvocation.purgeLoaders(context, mId, mInvocationClass);
            }
        }
    }
    ...
    private static class PurgeInputsExecution<INPUT> implements Execution {
        ...
        public void run() {
            ...
            if (context != null) {
                ...
                LoaderInvocation.purgeLoader(context, mId, mInvocationClass, mInputs);
            }
        }
    }
}
