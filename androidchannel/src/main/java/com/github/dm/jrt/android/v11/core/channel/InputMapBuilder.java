 ...
 */
class InputMapBuilder<DATA, IN extends DATA> extends AbstractBuilder<SparseArray<IOChannel<IN>>> {
    ...
    @NotNull
    @Override
    protected SparseArray<IOChannel<IN>> build(@NotNull final ChannelConfiguration configuration) {
