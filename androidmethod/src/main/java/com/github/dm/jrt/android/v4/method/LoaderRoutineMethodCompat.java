...
public class LoaderRoutineMethodCompat extends RoutineMethod
    ...
    public static class ObjectLoaderRoutineMethodCompat extends LoaderRoutineMethodCompat
        ...
        applyInvocationConfiguration() {
            return (InvocationConfiguration.Builder<? extends ObjectLoaderRoutineMethodCompat>)
                    super
                    .applyInvocationConfiguration();
        }
        ...
        public Builder<? extends ObjectLoaderRoutineMethodCompat> applyLoaderConfiguration() {
            return (Builder<? extends ObjectLoaderRoutineMethodCompat>) super
        ...
        applyObjectConfiguration() {
            return new ObjectConfiguration.Builder<ObjectLoaderRoutineMethodCompat>(this,
                    mConfiguration);
        }
    ...
    private static class MultiInvocation extends AbstractInvocation {
        ...
        protected Object invokeMethod(@Nullable final InputChannel<?> inputChannel) throws
            ...
            final LoaderRoutineMethodCompat routine = mInstance;
    ...
    private static class MultiInvocationFactory
        ...
        private MultiInvocationFactory(
                @NotNull final Class<? extends LoaderRoutineMethodCompat> type,
                @NotNull final Constructor<? extends LoaderRoutineMethodCompat> constructor,
                @NotNull final Object[] args, @NotNull final Method method,
                @NotNull final Object[] params) {
    ...
    private static class SingleInvocationFactory
        ...
        private final LoaderRoutineMethodCompat mRoutine;
         ...
         * @param params  the method parameters.
         */
        private SingleInvocationFactory(@NotNull final LoaderRoutineMethodCompat routine,
