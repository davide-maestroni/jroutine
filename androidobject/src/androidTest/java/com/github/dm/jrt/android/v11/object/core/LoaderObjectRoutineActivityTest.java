...
public class LoaderObjectRoutineActivityTest
    ...
    public void testActivityNullPointerErrors() {
        ...
        try {
            ...
            JRoutine.with((LoaderContext) null).on(factoryOf(TestInvocation.class));
        ...
        try {
            ...
            JRoutine.with((LoaderContext) null).on(classOfType(TestInvocation.class));
        ...
        try {
            ...
            JRoutine.with(loaderFrom(getActivity())).on(classOfType((Class<?>) null));
        ...
        try {
            ...
            JRoutine.with(loaderFrom(getActivity())).on(instanceOf(null, Reflection.NO_ARGS));
    ...
    public void testAsyncInputProxyRoutine() {
        ...
        final TimeDuration timeout = seconds(10);
        final SumItf sumAsync = JRoutine.with(loaderFrom(getActivity()))
    ...
    public void testAsyncOutputProxyRoutine() {
        ...
        final TimeDuration timeout = seconds(10);
        final CountItf countAsync = JRoutine.with(loaderFrom(getActivity()))
    ...
    public void testContextWrapper() {
        ...
        assertThat(JRoutine.with(loaderFrom(activity, contextWrapper))
    ...
    public void testException() throws NoSuchMethodException {
        ...
        final TimeDuration timeout = seconds(10);
        final Routine<Object, Object> routine3 = JRoutine.with(loaderFrom(getActivity()))
                                                         .on(instanceOf(TestClass.class))
    ...
    public void testMissingMethodError() {
        ...
        try {
            ...
            JRoutine.with(loaderFrom(getActivity())).on(instanceOf(TestClass.class)).method("test");
    ...
    public void testNullPointerError() {
        ...
        try {
            ...
            JRoutine.with(loaderFrom(getActivity())).on((ContextInvocationTarget) null);
        ...
        try {
            ...
            JRoutine.with(loaderFrom(getActivity())).on(instanceOf(null));
    ...
    public void testProxyAnnotations() {
        ...
        final Itf itf = JRoutine.with(loaderFrom(getActivity()))
    ...
    public void testProxyRoutine() {
        ...
        final TimeDuration timeout = seconds(10);
        final SquareItf squareAsync = JRoutine.with(loaderFrom(getActivity()))
                                              .on(instanceOf(Square.class))
                                              .buildProxy(SquareItf.class);
    ...
    public void testSharedFields() throws NoSuchMethodException {
        ...
        final LoaderObjectRoutineBuilder builder = JRoutine.with(loaderFrom(getActivity()))
