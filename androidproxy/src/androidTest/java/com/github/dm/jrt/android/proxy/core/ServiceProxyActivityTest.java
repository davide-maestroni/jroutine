...
public class ServiceProxyActivityTest extends ActivityInstrumentationTestCase2<TestActivity> {
    ...
    public void testProxy() {
        ...
        assertThat(testProxy.getList(JRoutine.io().<List<String>>of(list))
                            .iterator()
                            .next()).isEqualTo(list);
    ...
    public void testProxyBuilder() {
        ...
        final InvocationConfiguration configuration =
                builder().withLogLevel(Level.DEBUG).withLog(log).getConfigured();
        ...
        final ServiceProxyObjectBuilder<TestProxy> builder =
                com.github.dm.jrt.android.proxy.ServiceProxy_Test.with(serviceContext)
                                                                 .on(instanceOf(TestClass.class));
        final TestProxy testProxy = builder.withInvocations()
                                           .with(configuration)
                                           .getConfigured()
                                           .withService()
