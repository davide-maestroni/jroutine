...
public class LoaderProxyFragmentTest extends ActivityInstrumentationTestCase2<TestActivity> {
    ...
    public void testClassStaticMethod() {
        ...
        final TestFragment fragment = (TestFragment) getActivity().getFragmentManager()
                                                                  .findFragmentById(
                                                                          R.id.test_fragment);
        final TestStatic testStatic = JRoutineProxy.with(loaderFrom(fragment))
    ...
    public void testGenericProxyCache() {
        ...
        final TestFragment fragment = (TestFragment) getActivity().getFragmentManager()
                                                                  .findFragmentById(
                                                                          R.id.test_fragment);
        final LoaderProxyRoutineBuilder builder = JRoutineProxy.with(loaderFrom(fragment))
    ...
    public void testInterface() {
        ...
        final TestInterfaceProxy testProxy = JRoutineProxy.with(loaderFrom(fragment))
    ...
    public void testNullPointerError() {
        ...
        try {
            ...
            JRoutineProxy.with(loaderFrom(fragment))
                         .on(instanceOf(TestClass.class))
    ...
    public void testProxy() {
        ...
        final TestProxy testProxy = JRoutineProxy.with(loaderFrom(fragment))
                                                 .on(instanceOf(TestClass.class))
                                                 .withInvocations()
                                                 .withRunner(runner)
                                                 .withLogLevel(Level.DEBUG)
        ...
        assertThat(
                testProxy.getList(JRoutine.io().<List<String>>of(list)).iterator().next()).isSameAs(
                list);
    ...
    public void testProxyBuilder() {
        ...
        final InvocationConfiguration configuration =
                builder().withRunner(runner).withLogLevel(Level.DEBUG).withLog(log).getConfigured();
        ...
        final TestProxy testProxy =
                builder.withInvocations().with(configuration).getConfigured().buildProxy();
        ...
        assertThat(JRoutineProxy.with(loaderFrom(fragment))
                                .on(instanceOf(TestClass.class))
                                .withInvocations()
                                .with(configuration)
                                .getConfigured()
    ...
    public void testTemplates() {
        ...
        final TestFragment fragment = (TestFragment) getActivity().getFragmentManager()
                                                                  .findFragmentById(
                                                                          R.id.test_fragment);
        final Itf itf = JRoutineProxy.with(loaderFrom(fragment))
