 ...
 */
public class LoaderAdapterFactory extends CallAdapter.Factory {
    ...
    public CallAdapter<?> get(final Type returnType, final Annotation[] annotations,
        ...
        if (returnType instanceof ParameterizedType) {
            ...
            if (LoaderStreamChannel.class == rawType) {
            ...
            if (LoaderStreamChannel.class == returnType) {
                return new LoaderStreamChannelAdapter(mLoaderContext, invocationMode,
    ...
    private Routine<? extends Call<?>, ?> buildRoutine(@Nullable final Annotation[] annotations) {
        ...
        return JRoutineLoader.with(ConstantConditions.notNull("loader context", loaderContext))
    ...
    private static class LoaderStreamChannelAdapter extends BaseAdapter<LoaderStreamChannel> {
        ...
        public <OUT> LoaderStreamChannel adapt(final Call<OUT> call) {
            ...
            final LoaderStreamChannel<Call<OUT>, Call<OUT>> stream =
                    LoaderStreams.streamOf(call).with(mContext);
