...
public class LoaderStreamChannelTest extends ActivityInstrumentationTestCase2<TestActivity> {
    ...
    private static void testAppend(final Activity activity) {
        ...
        assertThat(LoaderStreamChannels.of("test1")
    ...
    private static void testBind(@NotNull final Activity activity) throws InterruptedException {
        ...
        LoaderStreamChannels.of("test").on(loaderFrom(activity)).onOutput(new Consumer<String>() {
        ...
        assertThat(semaphore.tryAcquire(3, TimeUnit.SECONDS)).isTrue();
        LoaderStreamChannels.of("test").on(loaderFrom(activity)).flow(new Consumer<String>() {
    ...
    private static void testCollect(@NotNull final Activity activity) {
        ...
        assertThat(LoaderStreamChannels.of(new StringBuilder("test1"), new StringBuilder("test2"),
    ...
    private static void testCollectCollection(@NotNull final Activity activity) {
        ...
        assertThat(LoaderStreamChannels.of("test1", "test2", "test3")
                                       .on(loaderFrom(activity))
                                       .async()
    ...
    private static void testConfiguration(@NotNull final Activity activity) {
        ...
        assertThat(LoaderStreamChannels.of("test1", "test2")
                                       .on(loaderFrom(activity))
                                       .parallel(1)
        ...
        assertThat(LoaderStreamChannels.of()
                                       .async()
    ...
    private static void testConsumeError(@NotNull final Activity activity) {
        ...
        assertThat(LoaderStreamChannels.of("test")
                                       .on(loaderFrom(activity))
                                       .sync()
                                       .map(new Function<Object, Object>() {
    ...
    private static void testFlatMap(@NotNull final Activity activity) {
        ...
        assertThat(LoaderStreamChannels.of("test1", null, "test2", null)
                                       .on(loaderFrom(activity))
                                       .sync()
                                       .flatMap(new Function<String, Channel<?, String>>() {
                                           ...
                                           public Channel<?, String> apply(final String s) {
                                               ...
                                               return LoaderStreamChannels.of(s)
                                                                          .on(loaderFrom(activity))
                                                                          .sync()
                                                                          .filter(Functions
                                                                                  .<String>isNotNull());
            ...
            LoaderStreamChannels.of("test")
                                ...
                                .map(new Function<String, Object>() {
                                    ...
                                    public Object apply(final String s) {
                                        ...
                                        return LoaderStreamChannels.of()
                                                                   .on(loaderFrom(activity))
                                                                   .invocationConfiguration()
                                                                   .withRunner(runner1)
                                                                   .applied()
    ...
    private static void testOnComplete(final Activity activity) {
        ...
        assertThat(
                LoaderStreamChannels.of("test").on(loaderFrom(activity)).onComplete(new Action() {
    ...
    private static void testOrElse(final Activity activity) {
        ...
        assertThat(LoaderStreamChannels.of()
                                       ...
                                       .after(seconds(10))
                                       .all()).containsExactly("est1", "est2");
        assertThat(LoaderStreamChannels.<String>of().on(loaderFrom(activity))
                                                    .orElseGetMore(
    ...
    private static void testThen(@NotNull final Activity activity) {
        ...
        assertThat(LoaderStreamChannels.from(new Supplier<String>() {
        ...
        assertThat(LoaderStreamChannels.fromMore(new Consumer<Channel<String, ?>>() {
        ...
        assertThat(LoaderStreamChannels.from(3, new Supplier<String>() {
            ...
            public String get() {
                ...
                "TEST2");
        assertThat(LoaderStreamChannels.fromMore(3, new Consumer<Channel<String, ?>>() {
    ...
    public void testAbort() {
        ...
        final LoaderStreamChannel<Object, Object> streamChannel =
                LoaderStreamChannels.of(channel).on(loaderFrom(getActivity()));
    ...
    public void testBuilder() {
        ...
        assertThat(LoaderStreamChannels.of().on(loaderFrom(getActivity())).after(seconds(10)).all())
                .isEmpty();
        assertThat(LoaderStreamChannels.of("test")
        ...
        assertThat(LoaderStreamChannels.of("test1", "test2", "test3")
                                       ...
                                       .after(seconds(10))
                                       .all()).containsExactly("test1", "test2", "test3");
        assertThat(LoaderStreamChannels.of(Arrays.asList("test1", "test2", "test3"))
                                       .on(loaderFrom(getActivity()))
                                       .after(seconds(10))
                                       .all()).containsExactly("test1", "test2", "test3");
        assertThat(LoaderStreamChannels.of(JRoutineCore.io().of("test1", "test2", "test3"))
                                       .on(loaderFrom(getActivity()))
                                       .after(seconds(10))
                                       .all()).containsExactly("test1", "test2", "test3");
    }
    ...
    public void testChannel() {
        ...
        StreamChannel<String, String> channel =
                LoaderStreamChannels.of("test").on(loaderFrom(getActivity()));
        ...
        channel = LoaderStreamChannels.of("test1", "test2", "test3").on(loaderFrom(getActivity()));
        try {
            channel.remove();
            fail();
        ...
        Iterator<String> iterator = LoaderStreamChannels.of("test1", "test2", "test3")
                                                        .on(loaderFrom(getActivity()))
                                                        .iterator();
        ...
        iterator = LoaderStreamChannels.of("test1", "test2", "test3")
                                       .on(loaderFrom(getActivity()))
                                       .eventualIterator();
        assertThat(iterator.hasNext()).isTrue();
        assertThat(iterator.next()).isEqualTo("test1");
        ...
        channel = LoaderStreamChannels.of(
    ...
    public void testCollectNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().collect(null);
            fail();
    ...
    public void testCollectSeedNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().collect(null, null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).sync().collect(null, null);
            fail();
    ...
    public void testConsumeErrorNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).onError(null);
            fail();
    ...
    public void testConsumeNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).sync().onOutput(consumer);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().onOutput(consumer);
            fail();
    ...
    public void testFilter() {
        ...
        assertThat(LoaderStreamChannels.of(null, "test")
                                       .on(loaderFrom(getActivity()))
                                       .async()
    ...
    public void testFilterNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().filter(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().parallel().filter(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).sync().filter(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().sequential().filter(null);
            fail();
    ...
    public void testFlatMapNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).sync().flatMap(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().flatMap(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).parallel().flatMap(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).sequential().flatMap(null);
            fail();
    ...
    public void testFlatMapRetry() {
        ...
        try {
            LoaderStreamChannels.of((Object) null)
                                .on(loaderFrom(getActivity()))
                                .async()
                                       ...
                                       .flatLift(
                                               new Function<StreamChannel<String, String>,
                                                   ...
                                                   public LoaderStreamChannel<String, String> apply(
                                                       ...
                                                       return ((LoaderStreamChannel<String,
                                                               String>) stream)
                                                               .append("test2");
                                                   }
                                               })
    ...
    public void testInvalidCalls() {
        final LoaderStreamChannel<String, String> channel = LoaderStreamChannels.of();
        try {
    ...
    public void testInvocationModeNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().invocationMode(null);
            fail();
    ...
    public void testMapAllConsumerNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().mapAllMore(null);
            fail();
    ...
    public void testMapAllFunctionNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().mapAll(null);
            fail();
    ...
    public void testMapConsumerNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().mapMore(null);
            fail();
    ...
    public void testMapContextFactoryIllegalState() {
        ...
        final ContextInvocationFactory<String, String> factory =
                ContextInvocationFactory.factoryOf(UpperCase.class);
        try {
            LoaderStreamChannels.of("test").async().map(factory);
            fail();
        ...
        try {
            LoaderStreamChannels.of("test").sync().map(factory);
            fail();
        ...
        try {
            LoaderStreamChannels.of("test").parallel().map(factory);
            fail();
        ...
        try {
            LoaderStreamChannels.of("test").sequential().map(factory);
            fail();
    ...
    public void testOrElseNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).orElseGetMore(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).orElseGetMore(1, null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).orElseGet(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).orElseGet(1, null);
            fail();
    ...
    public void testOutputToSelectable() {
        ...
        assertThat(LoaderStreamChannels.of(channel)
                                       .on(loaderFrom(getActivity()))
                                       .selectable(33)
                                       .after(seconds(10))
                                       .all()).containsExactly(
    ...
    public void testOutputToSelectableAbort() {
        ...
        try {
            LoaderStreamChannels.of(channel)
                                .on(loaderFrom(getActivity()))
                                .selectable(33)
                                .after(seconds(10))
                                .all();
    ...
    public void testPeekNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().peek(null);
            fail();
    ...
    public void testReduceNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().reduce(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).sync().reduce(null);
            fail();
    ...
    public void testReduceSeedNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().reduce(null, null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).sync().reduce(null, null);
            fail();
    ...
    public void testReplay() {
        ...
        final Channel<?, Object> channel =
                LoaderStreamChannels.of(inputChannel).on(loaderFrom(getActivity())).replay();
    ...
    public void testSize() {
        ...
        final Channel<?, Object> result = LoaderStreamChannels.of(channel.close());
    ...
    public void testStraight() {
        ...
        assertThat(LoaderStreamChannels.of()
                                       ...
                                       .applied()
                                       .map(sqrt())
                                       .map(LoaderStreamChannels.<Double>averageDouble())
                                       .next()).isCloseTo(21, Offset.offset(0.1));
    }
    ...
    public void testThenNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).sync().thenGetMore(3, null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).sync().thenGetMore(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).sync().thenGet(3, null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).sync().thenGet(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().thenGetMore(3, null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().thenGetMore(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().thenGet(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).async().thenGet(3, null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).parallel().thenGet(3, null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).parallel().thenGetMore(3, null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).sequential().thenGet(3, null);
            fail();
    ...
    public void testTryCatchNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).tryCatchMore(null);
            fail();
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).tryCatch(null);
            fail();
    ...
    public void testTryFinallyNullPointerError() {
        ...
        try {
            LoaderStreamChannels.of().on(loaderFrom(getActivity())).tryFinally(null);
            fail();
    ...
    private static class RetryFunction implements Function<Object, StreamChannel<Object, String>> {
        ...
        private static StreamChannel<Object, String> apply(final Object o,
            ...
            return LoaderStreamChannels.of(o)
                                       .on(loaderFrom(activity))
                                       .map(routine)
                                       .tryCatchMore(
