...
public class LoaderStreamChannelTest extends ActivityInstrumentationTestCase2<TestActivity> {
    ...
    private static void testAppend(final Activity activity) {
        ...
        assertThat(LoaderStreamChannels.streamOf("test1")
    ...
    private static void testCollect(@NotNull final Activity activity) {
        ...
        assertThat(LoaderStreamChannels.streamOf(new StringBuilder("test1"),
    ...
    private static void testConfiguration(@NotNull final Activity activity) {
        ...
        assertThat(LoaderStreamChannels.streamOf("test1", "test2")
                                       .on(loaderFrom(activity))
                                       .parallel(1)
    ...
    private static void testFlatMap(@NotNull final Activity activity) {
        ...
        assertThat(LoaderStreamChannels.streamOf("test1", null, "test2", null)
                                       .on(loaderFrom(activity))
                                       .sync()
                                       .flatMap(new Function<String, Channel<?, String>>() {
                                           ...
                                           public Channel<?, String> apply(final String s) {
                                               ...
                                               return LoaderStreamChannels.streamOf(s)
                                                                          .on(loaderFrom(activity))
                                                                          .sync()
                                                                          .filter(Functions
                                                                                  .<String>isNotNull());
            ...
            LoaderStreamChannels.streamOf("test")
                                ...
                                .map(new Function<String, Object>() {
                                    ...
                                    public Object apply(final String s) {
                                        ...
                                        return LoaderStreamChannels.streamOf()
                                                                   .on(loaderFrom(activity))
                                                                   .invocationConfiguration()
                                                                   .withRunner(runner1)
                                                                   .applied()
    ...
    private static void testOrElse(final Activity activity) {
        ...
        assertThat(LoaderStreamChannels.streamOf()
                                       ...
                                       .after(seconds(10))
                                       .all()).containsExactly("est1", "est2");
        assertThat(LoaderStreamChannels.<String>streamOf().on(loaderFrom(activity))
                                                          .orElseGetMore(
    ...
    public void testAbort() {
        ...
        final LoaderStreamChannel<Object, Object> streamChannel =
                LoaderStreamChannels.streamOf(channel).on(loaderFrom(getActivity()));
    ...
    public void testChannel() {
        ...
        StreamChannel<String, String> channel =
                LoaderStreamChannels.streamOf("test").on(loaderFrom(getActivity()));
        ...
        channel = LoaderStreamChannels.streamOf("test1", "test2", "test3")
                                      .on(loaderFrom(getActivity()));
        try {
            channel.remove();
            fail();
        ...
        Iterator<String> iterator = LoaderStreamChannels.streamOf("test1", "test2", "test3")
                                                        .on(loaderFrom(getActivity()))
                                                        .iterator();
        ...
        iterator = LoaderStreamChannels.streamOf("test1", "test2", "test3")
                                       .on(loaderFrom(getActivity()))
                                       .eventualIterator();
        assertThat(iterator.hasNext()).isTrue();
        assertThat(iterator.next()).isEqualTo("test1");
        ...
        channel = LoaderStreamChannels.streamOf(
    ...
    public void testCollectNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).async().collect(null);
            fail();
    ...
    public void testConsumeErrorNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).onError(null);
            fail();
    ...
    public void testConsumeNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).sync().onOutput(consumer);
            fail();
    ...
    public void testFilter() {
        ...
        assertThat(LoaderStreamChannels.streamOf(null, "test")
                                       .on(loaderFrom(getActivity()))
                                       .async()
    ...
    public void testFilterNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).async().filter(null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().parallel().filter(null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).sync().filter(null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().sequential().filter(null);
            fail();
    ...
    public void testFlatMapNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).sync().flatMap(null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).async().flatMap(null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).parallel().flatMap(null);
            fail();
    ...
    public void testFlatMapRetry() {
        ...
        try {
            LoaderStreamChannels.streamOf((Object) null)
                                .on(loaderFrom(getActivity()))
                                .async()
    ...
    public void testInvalidCalls() {
        final LoaderStreamChannel<String, String> channel = LoaderStreamChannels.streamOf();
        try {
    ...
    public void testInvocationModeNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().invocationMode(null);
            fail();
    ...
    public void testMapAllConsumerNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).async().mapAllMore(null);
            fail();
    ...
    public void testMapAllFunctionNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).async().mapAll(null);
            fail();
    ...
    public void testMapConsumerNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).async().mapMore(null);
            fail();
    ...
    public void testMapContextFactoryIllegalState() {
        ...
        final ContextInvocationFactory<String, String> factory =
                ContextInvocationFactory.factoryOf(UpperCase.class);
        try {
            LoaderStreamChannels.streamOf("test").async().map(factory);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf("test").sync().map(factory);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf("test").parallel().map(factory);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf("test").sequential().map(factory);
            fail();
    ...
    public void testOrElseNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).orElseGetMore(null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).orElseGetMore(1, null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).orElseGet(null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).orElseGet(1, null);
            fail();
    ...
    public void testOutputToSelectable() {
        ...
        assertThat(LoaderStreamChannels.streamOf(channel)
                                       .on(loaderFrom(getActivity()))
                                       .selectable(33)
                                       .after(seconds(10))
                                       .all()).containsExactly(
    ...
    public void testOutputToSelectableAbort() {
        ...
        try {
            LoaderStreamChannels.streamOf(channel)
                                .on(loaderFrom(getActivity()))
                                .selectable(33)
                                .after(seconds(10))
                                .all();
    ...
    public void testPeekNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).async().peek(null);
            fail();
    ...
    public void testReduceNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).async().reduce(null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).sync().reduce(null);
            fail();
    ...
    public void testReduceSeedNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).sync().reduce(null, null);
            fail();
    ...
    public void testReplay() {
        ...
        final Channel<?, Object> channel =
                LoaderStreamChannels.streamOf(inputChannel).on(loaderFrom(getActivity())).replay();
    ...
    public void testSize() {
        ...
        final Channel<?, Object> result = LoaderStreamChannels.streamOf(channel.close());
    ...
    public void testThenNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).sync().thenGetMore(null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).sync().thenGet(3, null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).sync().thenGet(null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).async().thenGetMore(null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).async().thenGet(null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).async().thenGet(3, null);
            fail();
    ...
    public void testTryCatchNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).tryCatchMore(null);
            fail();
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).tryCatch(null);
            fail();
    ...
    public void testTryFinallyNullPointerError() {
        ...
        try {
            LoaderStreamChannels.streamOf().on(loaderFrom(getActivity())).tryFinally(null);
            fail();
    ...
    private static class RetryFunction implements Function<Object, StreamChannel<Object, String>> {
        ...
        private static StreamChannel<Object, String> apply(final Object o,
            ...
            return LoaderStreamChannels.streamOf(o)
                                       .on(loaderFrom(activity))
                                       .map(routine)
                                       .tryCatchMore(
                                               new BiConsumer<RoutineException, Channel<String, ?>>() {
                                                   ...
                                                   public void accept(final RoutineException e,
                                                       ...
                                                       if (++count[0] < 3) {
                                                           LoaderStreamChannels.streamOf(o)
                                                                               .on(loaderFrom(
                                                                                       activity))
                                                                               .map(routine)
                                                                               .tryCatchMore(this)
