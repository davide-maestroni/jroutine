...
class BuilderWrapper<OUT> implements ChannelsBuilder<LoaderStreamChannel<OUT>>,
    ...
    public LoaderStreamChannel<OUT> build() {
        ...
        return new DefaultLoaderStreamChannel<OUT>(null, (OutputChannel<OUT>) mBuilder.build());
    }
    ...
    @NotNull
    public Builder<? extends ChannelsBuilder<LoaderStreamChannel<OUT>>> withChannels() {
