...
public class JRoutineLoaderStream {
    ...
    public static <IN> LoaderStreamBuilder<IN, IN> withStreamAccept(final int count,
        ...
        if (!ConsumerDecorator.decorate(consumer).hasStaticScope()) {
            throw new IllegalArgumentException(
                    "the consumer instance does not have a static scope: " + consumer.getClass()
                                                                                     .getName());
        }

        return JRoutineLoaderStream.<IN>withStream().lift(
    ...
    public static <IN> LoaderStreamBuilder<IN, IN> withStreamGet(final int count,
        ...
        if (!SupplierDecorator.decorate(supplier).hasStaticScope()) {
            throw new IllegalArgumentException(
                    "the supplier instance does not have a static scope: " + supplier.getClass()
                                                                                     .getName());
        }
