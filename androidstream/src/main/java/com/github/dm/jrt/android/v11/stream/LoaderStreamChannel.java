...
public interface LoaderStreamChannel<OUT>
     ...
     */
    @NotNull
    <AFTER> LoaderStreamChannel<AFTER> reduce(AFTER seed,
    ...
    /**
     * Short for {@code withLoaders().withCacheStrategy(strategyType).setConfiguration()}.
     *
    ...
    /**
     * Short for {@code withLoaders().withResultStaleTime(staleTime).setConfiguration()}.
     *
     ...
     */
    @NotNull
    Builder<? extends LoaderStreamChannel<OUT>> withLoaders();
     ...
     */
    @NotNull
    Builder<? extends LoaderStreamChannel<OUT>> withStreamLoaders();
}
