...
public interface LoaderStreamChannel<IN, OUT>
    ...
    @Override
    @StreamFlow(START)
    LoaderStreamChannel<IN, OUT> bind(@NotNull ChannelConsumer<? super OUT> consumer);
    ...
    @Override
    @StreamFlow(CONFIG)
    LoaderStreamChannel<IN, OUT> sort(@Nullable OrderType orderType);
    ...
    @Override
    @StreamFlow(CONFIG)
    LoaderStreamChannel<IN, OUT> straight();
