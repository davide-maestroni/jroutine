 ...
 */
public interface LoaderStreamChannelCompat<IN, OUT>
        extends StreamChannel<IN, OUT>, LoaderConfigurable<LoaderStreamChannelCompat<IN, OUT>> {
    ...
    @Override
    @StreamFlow(START)
    LoaderStreamChannelCompat<IN, OUT> close();
    ...
    @Override
    @StreamFlow(START)
    LoaderStreamChannelCompat<IN, OUT> pass(@Nullable Channel<?, ? extends IN> channel);
    ...
    @Override
    @StreamFlow(START)
    LoaderStreamChannelCompat<IN, OUT> pass(@Nullable Iterable<? extends IN> inputs);
    ...
    @Override
    @StreamFlow(START)
    LoaderStreamChannelCompat<IN, OUT> pass(@Nullable IN input);
    ...
    @Override
    @StreamFlow(START)
    LoaderStreamChannelCompat<IN, OUT> pass(@Nullable IN... inputs);
    ...
    @Override
    @StreamFlow(START)
    LoaderStreamChannelCompat<IN, OUT> sortedByCall();
    ...
    @Override
    @StreamFlow(START)
    LoaderStreamChannelCompat<IN, OUT> sortedByDelay();
    ...
    @Override
    @StreamFlow(MAP)
    LoaderStreamChannelCompat<IN, OUT> append(@NotNull Channel<?, ? extends OUT> channel);
    ...
    @Override
    @StreamFlow(MAP)
    LoaderStreamChannelCompat<IN, OUT> appendGet(@NotNull Supplier<? extends OUT> outputSupplier);
    ...
    @Override
    @StreamFlow(MAP)
    LoaderStreamChannelCompat<IN, OUT> delay(long delay, @NotNull TimeUnit timeUnit);
    ...
    @Override
    @StreamFlow(MAP)
    LoaderStreamChannelCompat<IN, OUT> delay(@NotNull UnitDuration delay);
    ...
    @Override
    @StreamFlow(MAP)
    LoaderStreamChannelCompat<IN, OUT> filter(@NotNull Predicate<? super OUT> filterPredicate);
    ...
    @Override
    @StreamFlow(START)
    LoaderStreamChannelCompat<IN, OUT> flow();
    ...
    @Override
    @StreamFlow(START)
    LoaderStreamChannelCompat<IN, OUT> flow(@NotNull Consumer<? super OUT> outputConsumer);
    ...
    @Override
    @StreamFlow(MAP)
    LoaderStreamChannelCompat<IN, OUT> lag(long delay, @NotNull TimeUnit timeUnit);
    ...
    @Override
    @StreamFlow(MAP)
    LoaderStreamChannelCompat<IN, OUT> lag(@NotNull UnitDuration delay);
    ...
    @Override
    @StreamFlow(MAP)
    LoaderStreamChannelCompat<IN, Void> onComplete(@NotNull Action completeAction);
    ...
    @Override
    @StreamFlow(MAP)
    LoaderStreamChannelCompat<IN, Void> onOutput(@NotNull Consumer<? super OUT> outputConsumer);
    ...
    @Override
    @StreamFlow(MAP)
    LoaderStreamChannelCompat<IN, OUT> orElseGet(@NotNull Supplier<? extends OUT> outputSupplier);
    ...
    @Override
    @StreamFlow(MAP)
    LoaderStreamChannelCompat<IN, OUT> peekComplete(@NotNull Action peekAction);
    ...
    @Override
    @StreamFlow(REDUCE)
    <AFTER> LoaderStreamChannelCompat<IN, AFTER> reduce(
            @NotNull Supplier<? extends AFTER> seedSupplier,
    ...
    @Override
    @StreamFlow(MAP)
    LoaderStreamChannelCompat<IN, ? extends ParcelableSelectable<OUT>> selectable(int index);
    ...
    @Override
    @StreamFlow(CONFIG)
    LoaderStreamChannelCompat<IN, OUT> straight();
    ...
    @Override
    @StreamFlow(MAP)
    LoaderStreamChannelCompat<IN, OUT> tryFinally(@NotNull Action finallyAction);
