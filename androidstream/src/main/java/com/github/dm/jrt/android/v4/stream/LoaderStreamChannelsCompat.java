 ...
 */
public class LoaderStreamChannelsCompat extends StreamChannels {

    /**
     * Avoid explicit instantiation.
     */
    protected LoaderStreamChannelsCompat() {
    ...
    @NotNull
    public static <OUT> LoaderStreamChannelCompat<OUT, OUT> from(final long count,
            @NotNull final Supplier<? extends OUT> outputSupplier) {
        final LoaderStreamChannelCompat<OUT, OUT> stream = of();
        return stream.thenGet(count, outputSupplier);
    }

    // TODO: 29/06/16 javadoc
    @NotNull
    public static <OUT> LoaderStreamChannelCompat<OUT, OUT> from(
            @NotNull final Supplier<? extends OUT> outputSupplier) {
        final LoaderStreamChannelCompat<OUT, OUT> stream = of();
    ...
    // TODO: 29/06/16 javadoc
    @NotNull
    public static <OUT> LoaderStreamChannelCompat<OUT, OUT> fromMore(final long count,
    ...
    // TODO: 29/06/16 javadoc
    @NotNull
    public static <OUT> LoaderStreamChannelCompat<OUT, OUT> fromMore(
            @NotNull final Consumer<? super Channel<OUT, ?>> outputsConsumer) {
        final LoaderStreamChannelCompat<OUT, OUT> stream = of();
     ...
     */
    @NotNull
    public static <OUT> LoaderStreamChannelCompat<OUT, OUT> of() {
     ...
     */
    @NotNull
    public static <OUT> LoaderStreamChannelCompat<OUT, OUT> of(@Nullable final OUT output) {
     ...
     */
    @NotNull
    public static <OUT> LoaderStreamChannelCompat<OUT, OUT> of(@Nullable final OUT... outputs) {
        return of(JRoutineCore.io().of(outputs));
    }
