 ...
 */
public abstract class ComparableFilterInvocation<IN, OUT> extends FilterInvocation<IN, OUT> {
     ...
     */
    protected ComparableFilterInvocation(@Nullable final Object[] args) {
