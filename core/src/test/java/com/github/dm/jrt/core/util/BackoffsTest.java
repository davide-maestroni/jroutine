...
public class BackoffsTest {
    ...
    public void testBackoffDecorator() {
        final Backoff backoff =
                new BackoffDecorator(Backoffs.afterCount(2).constantDelay(seconds(1)));
    ...
    public void testConstant() {
        ...
        final Backoff backoff1 = Backoffs.afterCount(0).constantDelay(1, TimeUnit.SECONDS);
        ...
        final Backoff backoff2 = Backoffs.afterCount(0).constantDelay(seconds(1));
        ...
        final Backoff backoff3 = Backoffs.afterCount(2).constantDelay(seconds(1));
    ...
    public void testConstantCapped() {
        ...
        final Backoff backoff1 =
                Backoffs.afterCount(0).constantDelay(1, TimeUnit.SECONDS).cappedTo(millis(500));
        assertThat(backoff1.getDelay(1)).isEqualTo(500);
        assertThat(backoff1.getDelay(2)).isEqualTo(500);
        final Backoff backoff2 = Backoffs.afterCount(0)
        ...
        final Backoff backoff3 = Backoffs.afterCount(1)
                                         .constantDelay(seconds(1))
                                         .cappedTo(700, TimeUnit.MILLISECONDS);
        assertThat(backoff3.getDelay(1)).isEqualTo(NO_DELAY);
    ...
    public void testConstantCappedJitter() {
        ...
        final Backoff backoff1 = Backoffs.afterCount(0)
                                         .constantDelay(seconds(1))
                                         .cappedTo(millis(500))
                                         .withJitter(0.5f);
    ...
    public void testConstantJitter() {
        ...
        final Backoff backoff1 =
                Backoffs.afterCount(0).constantDelay(1, TimeUnit.SECONDS).withJitter(0.7f);
        assertThat(backoff1.getDelay(1)).isBetween(300L, 1000L);
        assertThat(backoff1.getDelay(2)).isBetween(300L, 1000L);
        final Backoff backoff2 = Backoffs.afterCount(0).constantDelay(seconds(1)).withJitter(0.4f);
        ...
        final Backoff backoff3 = Backoffs.afterCount(1).constantDelay(seconds(1)).withJitter(0.4f);
        assertThat(backoff3.getDelay(1)).isEqualTo(NO_DELAY);
    ...
    public void testExponential() {
        ...
        final Backoff backoff1 = Backoffs.afterCount(0).exponentialDelay(1, TimeUnit.SECONDS);
        assertThat(backoff1.getDelay(1)).isEqualTo(1000);
        assertThat(backoff1.getDelay(2)).isEqualTo(2000);
        assertThat(backoff1.getDelay(3)).isEqualTo(4000);
        final Backoff backoff2 = Backoffs.afterCount(0).exponentialDelay(seconds(1));
        assertThat(backoff2.getDelay(1)).isEqualTo(1000);
        ...
        final Backoff backoff3 = Backoffs.afterCount(2).exponentialDelay(seconds(1));
        assertThat(backoff3.getDelay(1)).isEqualTo(NO_DELAY);
        assertThat(backoff3.getDelay(2)).isEqualTo(NO_DELAY);
        assertThat(backoff3.getDelay(3)).isEqualTo(1000);
    ...
    public void testExponentialCapped() {
        ...
        final Backoff backoff1 =
                Backoffs.afterCount(0).exponentialDelay(1, TimeUnit.SECONDS).cappedTo(seconds(5));
        assertThat(backoff1.getDelay(1)).isEqualTo(1000);
        assertThat(backoff1.getDelay(2)).isEqualTo(2000);
        assertThat(backoff1.getDelay(3)).isEqualTo(4000);
        final Backoff backoff2 =
                Backoffs.afterCount(0).exponentialDelay(seconds(1)).cappedTo(seconds(5));
        assertThat(backoff2.getDelay(1)).isEqualTo(1000);
        assertThat(backoff2.getDelay(2)).isEqualTo(2000);
        assertThat(backoff2.getDelay(3)).isEqualTo(4000);
        assertThat(backoff2.getDelay(4)).isEqualTo(5000);
        final Backoff backoff3 =
                Backoffs.afterCount(2).exponentialDelay(seconds(1)).cappedTo(seconds(5));
        assertThat(backoff3.getDelay(1)).isEqualTo(NO_DELAY);
        assertThat(backoff3.getDelay(2)).isEqualTo(NO_DELAY);
        assertThat(backoff3.getDelay(3)).isEqualTo(1000);
        assertThat(backoff3.getDelay(4)).isEqualTo(2000);
    ...
    public void testExponentialCappedJitter() {
        ...
        assertThat(backoff2.getDelay(4)).isEqualTo(5000);
        final Backoff backoff3 = Backoffs.afterCount(2)
                                         .exponentialDelay(seconds(1))
                                         .withJitter(0.3f)
                                         .cappedTo(seconds(5));
        assertThat(backoff3.getDelay(1)).isEqualTo(NO_DELAY);
    ...
    public void testExponentialJitter() {
        ...
        final Backoff backoff1 =
                Backoffs.afterCount(0).exponentialDelay(1, TimeUnit.SECONDS).withJitter(0.7f);
        assertThat(backoff1.getDelay(1)).isBetween(300L, 1000L);
        assertThat(backoff1.getDelay(2)).isBetween(600L, 2000L);
        final Backoff backoff2 =
                Backoffs.afterCount(0).exponentialDelay(seconds(1)).withJitter(0.4f);
        assertThat(backoff2.getDelay(1)).isBetween(600L, 1000L);
        assertThat(backoff2.getDelay(2)).isBetween(1200L, 2000L);
        assertThat(backoff2.getDelay(3)).isBetween(2400L, 4000L);
        final Backoff backoff3 =
                Backoffs.afterCount(1).exponentialDelay(seconds(1)).withJitter(0.4f);
        assertThat(backoff3.getDelay(1)).isEqualTo(NO_DELAY);
        assertThat(backoff3.getDelay(2)).isBetween(600L, 1000L);
    ...
    public void testJitter() {
        ...
        final Backoff backoff1 = Backoffs.afterCount(0).jitterDelay(1, TimeUnit.SECONDS);
        ...
        final Backoff backoff2 = Backoffs.afterCount(0).jitterDelay(seconds(1));
        ...
        final Backoff backoff3 = Backoffs.afterCount(1).jitterDelay(seconds(1));
        assertThat(backoff3.getDelay(1)).isEqualTo(NO_DELAY);
    ...
    public void testLinear() {
        ...
        final Backoff backoff1 = Backoffs.afterCount(0).linearDelay(1, TimeUnit.SECONDS);
        assertThat(backoff1.getDelay(1)).isEqualTo(1000);
        assertThat(backoff1.getDelay(2)).isEqualTo(2000);
        assertThat(backoff1.getDelay(3)).isEqualTo(3000);
        final Backoff backoff2 = Backoffs.afterCount(0).linearDelay(seconds(1));
        assertThat(backoff2.getDelay(1)).isEqualTo(1000);
        assertThat(backoff2.getDelay(2)).isEqualTo(2000);
        assertThat(backoff2.getDelay(3)).isEqualTo(3000);
        assertThat(backoff2.getDelay(4)).isEqualTo(4000);
        final Backoff backoff3 = Backoffs.afterCount(2).linearDelay(seconds(1));
        assertThat(backoff3.getDelay(1)).isEqualTo(NO_DELAY);
        assertThat(backoff3.getDelay(2)).isEqualTo(NO_DELAY);
        assertThat(backoff3.getDelay(3)).isEqualTo(1000);
        assertThat(backoff3.getDelay(4)).isEqualTo(2000);
    ...
    public void testLinearCapped() {
        ...
        final Backoff backoff2 =
                Backoffs.afterCount(0).linearDelay(seconds(1)).cappedTo(seconds(2.5));
        assertThat(backoff2.getDelay(1)).isEqualTo(1000);
        assertThat(backoff2.getDelay(2)).isEqualTo(2000);
        assertThat(backoff2.getDelay(3)).isEqualTo(2500);
        assertThat(backoff2.getDelay(4)).isEqualTo(2500);
        final Backoff backoff3 =
                Backoffs.afterCount(2).linearDelay(seconds(1)).cappedTo(seconds(1.5));
        assertThat(backoff3.getDelay(1)).isEqualTo(NO_DELAY);
        assertThat(backoff3.getDelay(2)).isEqualTo(NO_DELAY);
        assertThat(backoff3.getDelay(3)).isEqualTo(1000);
    ...
    public void testLinearJitter() {
        ...
        final Backoff backoff1 =
                Backoffs.afterCount(0).linearDelay(1, TimeUnit.SECONDS).withJitter(0.7f);
        assertThat(backoff1.getDelay(1)).isBetween(300L, 1000L);
        assertThat(backoff1.getDelay(2)).isBetween(600L, 2000L);
        assertThat(backoff1.getDelay(3)).isBetween(900L, 3000L);
        final Backoff backoff2 = Backoffs.afterCount(0).linearDelay(seconds(1)).withJitter(0.4f);
        assertThat(backoff2.getDelay(1)).isBetween(600L, 1000L);
        assertThat(backoff2.getDelay(2)).isBetween(1200L, 2000L);
        assertThat(backoff2.getDelay(3)).isBetween(1800L, 3000L);
        final Backoff backoff3 = Backoffs.afterCount(1).linearDelay(seconds(1)).withJitter(0.4f);
        assertThat(backoff3.getDelay(1)).isEqualTo(NO_DELAY);
        assertThat(backoff3.getDelay(2)).isBetween(600L, 1000L);
        assertThat(backoff3.getDelay(3)).isBetween(1200L, 2000L);
    }
    ...
    public void testNoDelay() {
        ...
        final Backoff backoff = Backoffs.noDelay();
        assertThat(backoff.getDelay(1)).isEqualTo(NO_DELAY);
        assertThat(backoff.getDelay(2)).isEqualTo(NO_DELAY);
