...
public class UnitTimeTest {
  ...
  public void testMinus() {
    ...
    assertThat(current.minus(UnitTime.hours(2).minus(UnitTime.minutes(11))).toMillis()).isEqualTo(
        current.toMillis() - UnitTime.hours(2).toMillis() + UnitTime.minutes(11).toMillis());
    assertThat(current.minus(UnitTime.hours(2)).minus(UnitTime.minutes(11)).toMillis()).isEqualTo(
        current.toMillis() - UnitTime.hours(2).toMillis() - UnitTime.minutes(11).toMillis());
  ...
  public void testPlus() {
    ...
    assertThat(current.plus(UnitTime.hours(2)).plus(UnitTime.minutes(11)).toMillis()).isEqualTo(
        current.toMillis() + UnitTime.hours(2).toMillis() + UnitTime.minutes(11).toMillis());
    assertThat(UnitTime.minutes(-2).plus(UnitTime.seconds(31))).isEqualTo(UnitTime.millis(-89000));
