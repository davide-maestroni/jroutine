...
public abstract class AbstractStatefulRoutineBuilder<IN, OUT, STATE, TYPE extends
    ...
    extends AbstractStatefulBuilder<IN, OUT, STATE, StatefulRoutineBuilder<IN, OUT, STATE>>
  ...
  private final Configurable<TYPE> mConfigurable = new Configurable<TYPE>() {
    ...
    public TYPE withConfiguration(@NotNull final InvocationConfiguration configuration) {
      return AbstractStatefulRoutineBuilder.this.withConfiguration(configuration);
    }
  };
