 ...
 * <p/>
 * A Flow is responsible for running a flow of data feeding a {@link com.bmd.wtf.src.Pool}.
 * <p/>
...
public interface Flow {
    ...
    /**
     * This method is called when a data drop must be discharged through the flow.
     *
    ...
    /**
     * This method is called when data drops must be discharged through the flow, after the
     * specified time has elapsed.
     *
     * @param pool     The pool instance to be used to discharge data into the waterfall.
     * @param delay    The delay in <code>timeUnit</code> time units.
    ...
    /**
     * This method is called when data must be flushed through the flow.
     *
     * @param pool The pool instance to be used to discharge data into the waterfall.
     */
    ...
    /**
     * This method is called when an object must be pulled upstream through the flow.
     *
     * @param pool   The pool instance to be used to discharge data into the waterfall.
    ...
    /**
     * This method is called when an object must be pushed downstream through the flow.
     *
     * @param pool   The pool instance to be used to discharge data into the waterfall.
