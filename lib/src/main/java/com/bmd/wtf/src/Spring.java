 ...
 * <p/>
 * A spring defines the way the data are fed to the {@link com.bmd.wtf.Waterfall}.
 * <p/>
 * Note that a <code>Waterfall</code> may have several <code>Springs</code> feeding its streams.
 * <p/>
