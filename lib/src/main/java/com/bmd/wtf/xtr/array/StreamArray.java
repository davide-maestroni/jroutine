...
public class StreamArray<SOURCE, IN, OUT> {
    ...
    /**
     * Constructs an array of streams where every stream is the source one.
     *
    ...
    /**
     * Constructs and array of streams from the specified ones.
     *
