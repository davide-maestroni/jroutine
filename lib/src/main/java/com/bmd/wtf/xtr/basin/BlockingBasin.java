...
/**
 * Implementation of a {@link Basin} which can block waiting for the data
...
public class BlockingBasin<IN, OUT> extends Basin<IN, OUT> {
     ...
     */
    public static <IN, OUT> BlockingBasin<IN, OUT> collectFrom(final Stream<IN, ?, OUT> stream) {
     ...
     * @return The new basin.
     */
    public static <IN, OUT> BlockingBasin<IN, OUT> collectFrom(
            final Stream<IN, ?, OUT>... streams) {
