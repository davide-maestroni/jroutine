...
/**
 * Utility class used to build {@link com.bmd.wtf.dam.Dam} objects with the ability to specify only part of the Dam
 * behavior.
 * <p/>
...
public class DamBuilder<IN, OUT> {
    ...
    /**
     * Creates a new builder from the specified handler.
     *
     * @param handler The discharge handler.
     * @param <IN>    The input data type.
     * @param <OUT>   The output data type.
     ...
     */
    public static <IN, OUT> DamBuilder<IN, OUT> basedOnHandler(
        ...
        if (mAvoidNull) {
            ...
            dam = new Dam<IN, OUT>() {
                ...
                public Object onDischarge(final Floodgate<IN, OUT> gate, final IN drop) {
                    ...
                    final OUT out = discharge.onDischarge(drop);
                ...
                public Object onPushDebris(final Floodgate<IN, OUT> gate, final Object debris) {
                    ...
                    return push.onPushDebris(debris);
                }
                ...
                public Object onPullDebris(final Floodgate<IN, OUT> gate, final Object debris) {
                    ...
                    return pull.onPullDebris(debris);
                }
            };
            ...
            dam = new Dam<IN, OUT>() {
                ...
                public Object onDischarge(final Floodgate<IN, OUT> gate, final IN drop) {
                    ...
                    gate.discharge(discharge.onDischarge(drop));
