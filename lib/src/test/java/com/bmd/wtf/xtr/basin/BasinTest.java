...
public class BasinTest extends TestCase {
    ...
    public void testBlocking() throws InterruptedException {
        ...
        final BlockingBasin<String, Integer> basin1 = BlockingBasin.collectFrom(
        ...
        assertThat(
                BlockingBasin.collectFrom(stream1, stream2, stream3, stream1).thenFeedWith("test")
                             .collectOutput()
        ).containsExactly("test", "test", "test");
        assertThat(BlockingBasin.collectFrom(Arrays.asList(stream1, stream2, stream3, stream2))
                                .thenFeedWith("test").collectOutput())
                .containsExactly("test", "test", "test");
    }
    ...
    public void testBlockingError() {
        ...
        try {
            ...
            BlockingBasin.collectFrom((Stream<Object, ?, Object>) null);
        ...
        try {
            ...
            BlockingBasin.collectFrom(new Stream[0]);
        ...
        try {
            ...
            BlockingBasin.collectFrom((Iterable<Stream<Object, ?, Object>>) null);
        ...
        final BlockingBasin<String, Integer> basin1 =
                BlockingBasin.collectFrom(Waterfall.fallingFrom(new AbstractDam<String, Integer>() {
