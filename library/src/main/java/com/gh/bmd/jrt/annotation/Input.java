...
public @interface Input {
    ...
    /**
     * Asynchronous input mode.<br/>
     * The type indicates in which way a parameter is passed to the wrapped method.
     */
    enum InputMode {
         ...
         * parameters match the COLLECTION mode, they are assigned it; if they match the VALUE mode,
         * they are assigned the latter; finally the ELEMENT conditions are checked.
         */
        AUTO
    }
}
