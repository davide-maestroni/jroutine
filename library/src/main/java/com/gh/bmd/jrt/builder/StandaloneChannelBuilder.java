 ...
 */
public interface StandaloneChannelBuilder {
     ...
     * Only options related to the output channel, the asynchronous runner and the logs will be
     * employed.
     * <p/>
     ...
     */
    @Nonnull
    Builder<? extends StandaloneChannelBuilder> routineConfiguration();
}
