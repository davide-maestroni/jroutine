...
public interface ObjectRoutineBuilder extends ClassRoutineBuilder {
    ...
    @Nonnull
    @Override
    public ObjectRoutineBuilder withConfiguration(@Nullable RoutineConfiguration configuration);

    @Nonnull
    @Override
    public ObjectRoutineBuilder withShareGroup(@Nullable String group);
}
