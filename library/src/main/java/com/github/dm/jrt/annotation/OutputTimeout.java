 ...
 *              &#64;com.github.dm.jrt.annotation.OutputTimeout *;
 *         }
 *     </code>
 * </pre>
 * <p/>
...
public @interface OutputTimeout {
    ...
    /**
     * The time unit of the timeout for an output channel to have room for additional data.
     *
    ...
    /**
     * The timeout for an output channel to have room for additional data.
     *
     * @return the timeout.
     */
    long value();
