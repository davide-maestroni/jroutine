...
/**
 * Generating invocation used to call a consumer a specific number of times.
 * <p>
 * Created by davide-maestroni on 04/19/2016.
 *
 * @param <OUT> the output data type.
 */
class ThenConsumerInvocation<OUT> extends GenerateInvocation<Object, OUT> {
     ...
     */
    ThenConsumerInvocation(final long count,
