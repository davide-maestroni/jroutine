...
public class OperatorsTest {
  ...
  public void testAppend() {
    assertThat(
        JRoutineCore.with(append("test2")).call("test1").after(seconds(3)).all()).containsExactly(
        "test1", "test2");
  ...
  public void testAppend2() {
    ...
    })).call("test1").after(seconds(3)).all()).containsExactly("test1", "TEST2", "TEST2", "TEST2");
    assertThat(JRoutineCore.with(appendAccept(3, new Consumer<Channel<String, ?>>() {
    ...
    })).callParallel("test1").after(seconds(3)).all()).containsExactly("test1", "TEST2", "TEST2",
        "TEST2");
    assertThat(JRoutineCore.with(appendAccept(3, new Consumer<Channel<String, ?>>() {
  ...
  public void testAverage() {
    assertThat(JRoutineCore.with(Operators.average()).close().after(seconds(3)).next()).isEqualTo(
        0);
    assertThat(JRoutineCore.with(Operators.average()).call(1L, 2L, 3L, 4L).after(seconds(3)).next())
        .isEqualTo(2L);
    assertThat(
        JRoutineCore.with(Operators.average()).call(1, 2, 3, 4).after(seconds(3)).next()).isEqualTo(
        2);
    ...
    assertThat(JRoutineCore.with(Operators.average())
                           ...
                           .after(seconds(3))
                           .next()).isEqualTo(2.5);
    assertThat(JRoutineCore.with(Operators.average()).call(1f, 2f, 3f, 4f).after(seconds(3)).next())
        .isEqualTo(2.5f);
    assertThat(JRoutineCore.with(Operators.average())
  ...
  public void testAverageByte() {
    assertThat(
        JRoutineCore.with(Operators.averageByte()).close().after(seconds(3)).next()).isEqualTo(
        (byte) 0);
    assertThat(JRoutineCore.with(Operators.averageByte())
                           .call(1L, 2L, 3L, 4L)
                           .after(seconds(3))
                           .next()).isEqualTo((byte) 2);
    assertThat(JRoutineCore.with(Operators.averageByte()).call(1, 2, 3, 4).after(seconds(3)).next())
        .isEqualTo((byte) 2);
    assertThat(JRoutineCore.with(Operators.averageByte())
                           .call((short) 1, (short) 2, (short) 3, (short) 4)
                           .after(seconds(3))
  ...
  public void testAverageDouble() {
    assertThat(
        JRoutineCore.with(Operators.averageDouble()).close().after(seconds(3)).next()).isEqualTo(
        0d);
  ...
  public void testAverageFloat() {
    assertThat(
        JRoutineCore.with(Operators.averageFloat()).close().after(seconds(3)).next()).isEqualTo(0f);
  ...
  public void testAverageInteger() {
    assertThat(
        JRoutineCore.with(Operators.averageInteger()).close().after(seconds(3)).next()).isEqualTo(
        0);
    assertThat(
        JRoutineCore.with(Operators.averageInteger()).call(1L, 2L, 3L, 4L).after(seconds(3)).next())
        .isEqualTo(2);
    ...
    assertThat(JRoutineCore.with(Operators.averageInteger())
                           ...
                           .next()).isEqualTo(2);
    assertThat(
        JRoutineCore.with(Operators.averageInteger()).call(1f, 2f, 3f, 4f).after(seconds(3)).next())
        .isEqualTo(2);
    assertThat(JRoutineCore.with(Operators.averageInteger())
                           .call(BigInteger.valueOf(1), BigInteger.valueOf(2),
                               BigInteger.valueOf(3), BigInteger.valueOf(4))
  ...
  public void testAverageLong() {
    assertThat(
        JRoutineCore.with(Operators.averageLong()).close().after(seconds(3)).next()).isEqualTo(0L);
    assertThat(JRoutineCore.with(Operators.averageLong())
                           .call(1L, 2L, 3L, 4L)
                           .after(seconds(3))
                           .next()).isEqualTo(2L);
    assertThat(JRoutineCore.with(Operators.averageLong()).call(1, 2, 3, 4).after(seconds(3)).next())
        .isEqualTo(2L);
    assertThat(JRoutineCore.with(Operators.averageLong())
                           .call((short) 1, (short) 2, (short) 3, (short) 4)
                           .after(seconds(3))
  ...
  public void testAverageShort() {
    assertThat(
        JRoutineCore.with(Operators.averageShort()).close().after(seconds(3)).next()).isEqualTo(
        (short) 0);
  ...
  public void testCollectCollection() {
    ...
    })).call("test1", "test2", "test3").after(seconds(3)).next()).containsExactly("test1", "test2",
        "test3");
    assertThat(JRoutineCore.with(collectInto(new Supplier<List<String>>() {
  ...
  public void testCount() {
    assertThat(JRoutineCore.with(Operators.count())
                           ...
                           .after(seconds(3))
                           .next()).isEqualTo(10);
    assertThat(JRoutineCore.with(Operators.count()).close().after(seconds(3)).next()).isEqualTo(0);
  }

  @Test
  public void testDistinct() {
    assertThat(JRoutineCore.with(Operators.distinct()).call("test", "test").after(seconds(3)).all())
  ...
  public void testDistinctIdentity() {
    ...
    objects = JRoutineCore.with(Operators.distinctIdentity()).call(o1, o2).after(seconds(3)).all();
  ...
  public void testEqualTo() {
    ...
    assertThat(JRoutineCore.with(Operators.isEqualTo(0)).close().after(seconds(3)).all()).isEmpty();
  ...
  public void testFilter() {
    assertThat(
        JRoutineCore.with(filter(Functions.isNotNull())).call(null, "test").after(seconds(3)).all())
        .containsExactly("test");
  ...
  public void testNotEqualTo() {
    ...
    assertThat(
        JRoutineCore.with(Operators.isNotEqualTo(0)).close().after(seconds(3)).all()).isEmpty();
  ...
  public void testNotSameAs() {
    ...
    assertThat(
        JRoutineCore.with(Operators.isNotSameAs(0)).close().after(seconds(3)).all()).isEmpty();
  ...
  public void testOrElse() {
    assertThat(
        JRoutineCore.with(orElse("est")).call("test").after(seconds(3)).all()).containsExactly(
        "test");
  ...
  public void testPeekComplete() {
    ...
    })).call("test1", "test2", "test3").after(seconds(3)).all()).containsExactly("test1", "test2",
        "test3");
  ...
  public void testPrepend() {
    assertThat(
        JRoutineCore.with(prepend("test2")).call("test1").after(seconds(3)).all()).containsExactly(
        "test2", "test1");
  ...
  public void testPrepend2() {
    ...
    })).call("test1").after(seconds(3)).all()).containsExactly("TEST2", "TEST2", "TEST2", "test1");
    assertThat(JRoutineCore.with(prependAccept(3, new Consumer<Channel<String, ?>>() {
    ...
    })).callParallel("test1").after(seconds(3)).all()).containsExactly("TEST2", "TEST2", "TEST2",
        "test1");
    assertThat(JRoutineCore.with(prependAccept(3, new Consumer<Channel<String, ?>>() {
  ...
  public void testReplace() {
    ...
    })).call("test1", "test2", "test3").after(seconds(3)).all()).containsExactly("test1", "test",
        "test3");
  }
  ...
  public void testSameAs() {
    ...
    assertThat(JRoutineCore.with(Operators.isSameAs(0)).close().after(seconds(3)).all()).isEmpty();
  ...
  @Test
  public void testSum() {
    assertThat(JRoutineCore.with(Operators.sum()).close().after(seconds(3)).next()).isEqualTo(0);
    assertThat(
        JRoutineCore.with(Operators.sum()).call(1, 2, 3, 4).after(seconds(3)).next()).isEqualTo(10);
  }

  @Test
  public void testSumBig() {
    assertThat(
        JRoutineCore.with(Operators.sumBig()).call(1, 2, 3, 4).after(seconds(3)).next()).isEqualTo(
        new BigDecimal(10));
  }

  @Test
  public void testSumByte() {
    assertThat(JRoutineCore.with(Operators.sumByte()).close().after(seconds(3)).next()).isEqualTo(
        (byte) 0);
    assertThat(
        JRoutineCore.with(Operators.sumByte()).call(1, 2, 3, 4).after(seconds(3)).next()).isEqualTo(
        (byte) 10);
  }

  @Test
  public void testSumDouble() {
    assertThat(JRoutineCore.with(Operators.sumDouble()).close().after(seconds(3)).next()).isEqualTo(
        0d);
  ...
  public void testSumFloat() {
    assertThat(JRoutineCore.with(Operators.sumFloat()).close().after(seconds(3)).next()).isEqualTo(
        0f);
  ...
  public void testSumInteger() {
    assertThat(
        JRoutineCore.with(Operators.sumInteger()).close().after(seconds(3)).next()).isEqualTo(0);
  ...
  public void testSumLong() {
    assertThat(JRoutineCore.with(Operators.sumLong()).close().after(seconds(3)).next()).isEqualTo(
        0L);
    assertThat(
        JRoutineCore.with(Operators.sumLong()).call(1, 2, 3, 4).after(seconds(3)).next()).isEqualTo(
        10L);
  }

  @Test
  public void testSumShort() {
    assertThat(JRoutineCore.with(Operators.sumShort()).close().after(seconds(3)).next()).isEqualTo(
        (short) 0);
  ...
  public void testThen() {
    assertThat(
        JRoutineCore.with(then("test2")).call("test1").after(seconds(3)).all()).containsExactly(
        "test2");
  ...
  public void testToArray() {
    ...
    assertThat(JRoutineCore.with(Operators.toArray())
                           ...
                           .next()).containsExactly("test1", "test2");
    assertThat(
        JRoutineCore.with(Operators.toArray()).call(1, 2).after(seconds(3)).next()).containsExactly(
        1, 2);
  }
  ...
  public void testToSet() {
    ...
    assertThat(JRoutineCore.with(Operators.toSet()).call("test1", "test2").after(seconds(3)).next())
