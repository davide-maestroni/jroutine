...
public class SequencesTest {
  ...
  public void testRange() {
    ...
    assertThat(JRoutineCore.with(consumerCommand(range(0, 2, 0.7))).close().after(seconds(3)).all())
    ...
    assertThat(
        JRoutineCore.with(consumerCommand(range(0, -5))).close().after(seconds(3)).all()).isEqualTo(
