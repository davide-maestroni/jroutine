...
public interface ProxyRoutineBuilder
    extends InvocationConfigurable<ProxyRoutineBuilder>, WrapperConfigurable<ProxyRoutineBuilder> {
   ...
   * explicitly calling the {@code &lt;generated_class_name&gt;.wrapper()} methods.
   * <p>
