...
public class ProxyRoutineTest {
  ...
  public void testSharedFields() {
    ...
    final ProxyRoutineBuilder builder =
        JRoutineProxy.wrapper().withInvocation().withOutputTimeout(seconds(2)).configuration();
  ...
  @Proxy(value = TestClass.class, className = "Test", classPackage = "com.github.dm.jrt.proxy")
