 ...
 * output channel to have room for additional data. The specified class must have a default
 * constructor.
 * <p>
 ...
 *   &#64;com.github.dm.jrt.reflect.annotation.OutputBackoff *;
 * }
 * </code></pre>
 * <p>
...
public @interface OutputBackoff {

  /**
   * The backoff to apply while waiting for an output channel to have room for additional data.
   *
