...
public interface ReflectionRoutineBuilder extends InvocationConfigurable<ReflectionRoutineBuilder>,
   ...
   * {@link #methodOf(InvocationTarget, String, Class[])} with no parameter.
   * <br>
   * Optional <i>{@code com.github.dm.jrt.reflect.annotation.*}</i> method annotations will be
   ...
   */
  @NotNull
  <IN, OUT> Routine<IN, OUT> methodOf(@NotNull InvocationTarget<?> target, @NotNull String name);
   ...
   * <i>{@code com.github.dm.jrt.reflect.annotation.*}</i> method annotations will be honored. Such
   * annotations will override any configuration set through the builder.
   * <p>
   * Note that it is responsibility of the caller to retain a strong reference to the target
   * instance to prevent it from being garbage collected.
   * <br>
   ...
   */
  @NotNull
  <IN, OUT> Routine<IN, OUT> methodOf(@NotNull InvocationTarget<?> target, @NotNull Method method);

  /**
   * Returns a proxy object enabling asynchronous call of the target instance methods.
   * <p>
   * The routines used for calling the methods will honor the attributes specified in any optional
   * <i>{@code com.github.dm.jrt.reflect.annotation.*}</i> annotations. Such annotations will
   * override any configuration set through the builder.
   * <p>
   ...
   */
  @NotNull
  <TYPE> TYPE proxyOf(@NotNull InvocationTarget<?> target, @NotNull ClassToken<TYPE> itf);
   ...
   */
  @NotNull
  <TYPE> TYPE proxyOf(@NotNull InvocationTarget<?> target, @NotNull Class<TYPE> itf);
}
