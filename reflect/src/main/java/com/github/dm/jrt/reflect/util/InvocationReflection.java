...
/**
 * Utility class providing helper methods used to implement invocations calling other objects via
 * reflection.
 * <p>
 * Created by davide-maestroni on 03/23/2015.
 */
@SuppressWarnings("WeakerAccess")
public class InvocationReflection {
   ...
   */
  protected InvocationReflection() {
