...
/**
 * Filter of downloaded URIs filtering the ones already in progress.
 */
public class RapidDownloadFilter extends RapidGate implements DownloadFilter {
    ...
    public void cancelDownload(final URI uri) {
        ...
        mDownloading.remove(uri);
        mDownloaded.remove(uri);
    }

    @Override
    public Download getDownload(final URI uri) {

        return mDownloading.get(uri);
    }
    ...
    @Override
    public void setDownloaded(final Download download) {
