...
/**
 * Interface defining a function transforming a stream routine.
 * <p>
 ...
 */
public interface TransformingFunction<IN, OUT, BEFORE, AFTER>
    extends Function<StreamRoutine<IN, OUT>, StreamRoutine<BEFORE, AFTER>> {
