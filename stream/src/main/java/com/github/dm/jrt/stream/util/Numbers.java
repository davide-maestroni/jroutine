...
public class Numbers {
     ...
     * @param n2 the second number.
     * @return the sum.
     * @throws java.lang.IllegalArgumentException if one of the two instance is of an unsupported
     *                                            type.
     */
    @NotNull
    @SuppressWarnings("ConstantConditions")
    ...
    public static boolean isSupported(@NotNull final Class<? extends Number> type) {
        ...
        return Integer.class.isAssignableFrom(type) || Long.class.isAssignableFrom(type)
                ...
                || BigInteger.class.isAssignableFrom(type) || BigDecimal.class.isAssignableFrom(
                type);
    }
